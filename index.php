				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>banqueteasy_profits
YOUR PROFITS. OUR RESPONSIBILITY.
MORE CUSTOMERS!

Increase your reach and be found by more customers!</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>YOUR EVENTS. OUR REMINDERS.
UPCOMING EVENT REMINDERS!

We will alert you about upcoming events
on your smartphone.
